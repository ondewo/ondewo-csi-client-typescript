...
import * as ondewo_csi_conversation_pb from '../../ondewo/csi/conversation_pb'; // proto import: "ondewo/csi/conversation.proto"
...
export class ConversationsClient {
  ...
  getS2sPipeline(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_csi_conversation_pb.S2sPipeline) => void
  ...
  listS2sPipelines(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_csi_conversation_pb.ListS2sPipelinesResponse) => void
  ...
  checkUpstreamHealth(
    ...
    metadata: grpcWeb.Metadata | undefined,
    callback: (err: grpcWeb.RpcError,
               response: ondewo_csi_conversation_pb.CheckUpstreamHealthResponse) => void
